    ...
    <Fragment>
        <div className='w-full h-screen flex justify-center items-center bg-slate-50'>
            <div className="bg-green-200 w-80 px-2 py-4 rounded-md">
                <div className="image"><img src={require('../assets/image/touristguide.png')} alt="" srcset="" className='w-16 mx-auto'/></div>
            {error?<p className='text-red-500 text-center'>Email Or Password Are wrong</p>:''}         
                ...
                <input type="password" className='w-full h-9 px-3 bg-white rounded-md my-1 outline-none border-none' placeholder='Password' onChange={loginData} name="password"/>
